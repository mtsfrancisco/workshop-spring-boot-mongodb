package com.mtsfrancisco.workshopmongo.config;
...
import com.mtsfrancisco.workshopmongo.dto.AuthorDTO;
import com.mtsfrancisco.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Boao", sdf.parse("21/03/2020"), new AuthorDTO(alex));
